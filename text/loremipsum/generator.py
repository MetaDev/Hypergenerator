...
_SAMPLE = str(resource_string(__name__, 'default/sample.txt'))
_DICTIONARY = str(resource_string(__name__, 'default/dictionary.txt'))
_SAMPLE = _SAMPLE.encode('UTF-8')
_DICTIONARY = _DICTIONARY.encode('UTF-8').split()
